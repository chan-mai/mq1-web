...
<template>
  <div
    class="max-w-6xl mx-auto px-4 mb-12 sm:mb-20 pt-8 border-t border-border-subtle"
  >
      ...
      <div class="flex flex-col h-full">
        ...
        >
          ...
          >
            <!-- Label & Icon -->
            <div
              class="flex items-center text-fg-muted group-hover:text-primary transition-colors duration-300 mb-3"
            >
            ...
            <div class="flex gap-4 items-start">
              ...
              <div
                class="hidden sm:block shrink-0 w-24 h-24 rounded-lg overflow-hidden bg-surface-muted"
              >
                <MqOgImage
