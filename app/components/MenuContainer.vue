...
<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <span
          class="font-accent text-[96px] md:text-[160px] leading-none tracking-[0.15em] text-white/[0.02]"
        >
          {{ config.siteName }}
        </span>
      </div>
        ...
        >
          ...
          >
            ...
            <ul class="flex gap-[1rem]">
              ...
              >
                <NuxtLink
                  class="text-white cursor-react-sml"
                  :to="social.url"
                  target="_blank"
          ...
          <p
            ...
            :class="
              isVisible ? 'opacity-100 delay-[1200ms]' : 'opacity-0 delay-0'
            "
          >
