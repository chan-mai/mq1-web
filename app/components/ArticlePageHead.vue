...
<template>
    ...
    <div class="flex flex-col gap-5">
        <h1 class="text-3xl leading-snug text-fg md:text-4xl md:leading-normal" :style="`view-transition-name: article-title-${contentId}`">
            {{ title }}
        </h1>
        ...
        <slot>
            <dl class="flex flex-row flex-wrap gap-3 text-xs sm:gap-4">
                <div v-if="published" class="flex flex-col gap-1 rounded-lg bg-surface-elevated px-4 py-2.5">
                ...
                <div v-if="updatedDate" class="flex flex-col gap-1 rounded-lg bg-surface-elevated px-4 py-2.5">
                ...
                <div v-if="author" class="flex flex-col gap-1 rounded-lg bg-surface-elevated px-4 py-2.5">
                ...
                <div v-if="readingTime" class="flex flex-col gap-1 rounded-lg bg-surface-elevated px-4 py-2.5">
