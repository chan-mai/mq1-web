...
export default function useOgGenerator(title: string){
    const baseImageURL: string = 'https://images.microcms-assets.io/assets/3aba23b5bd6f4b79800a0305d0e4f8aa/0e80c5071f0a441c96aa0d1ff525a2ce/og.png/?blend-mode=normal&w=1200&mark-align=center%2Cmiddle&fm=webp&blend64=';
    let titleImageURL: string = 'https://images.microcms-assets.io/~text?txtsize=60&w=1100&h=350&txt-color=f57aa5&txt-align=left,top&txtfont=Hiragino%20Sans%20W3&fm=webp&txt64='+base64urlEncode(title);
