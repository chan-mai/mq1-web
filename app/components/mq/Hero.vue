  ...
  <section class="relative w-full" data-header-inverse="true">
    ...
    <template v-else>
      <div class="absolute inset-0 overflow-hidden dot-overlay">
        <NuxtImg src="/images/hero.png" format="webp" sizes="xs:100vw sm:100vw md:100vw lg:1200px" :alt="title"
          fetchpriority="high" class="block size-full object-cover" />
      </div>
      ...
      <div v-if="!textHidden"
        ...
        <p class="font-futura text-xs tracking-[0.25em] uppercase text-white/70 font-medium">
          engineer &amp; creator
        </p>
