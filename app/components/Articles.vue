...
const limitedArticles = computed(() => {
  return limit > 0 ? props.articles.slice(0, limit) : props.articles;
});
...
<template>
  <div class="max-w-6xl p-4">
    <div class="relative">
      <div
        class="absolute left-[14px] top-0 bottom-0 w-[1px] bg-border-subtle"
      ></div>
      ...
      <div class="space-y-8">
        ...
        >
          <div
            :class="`absolute left-0 top-0 flex items-center justify-center w-7 h-7 rounded-full z-10
            ...
            <div class="flex flex-col md:flex-row md:items-start pl-10 pb-8">
              ...
              <div class="slide-hover p-4 rounded-lg flex-grow overflow-hidden">
                <div class="flex flex-col md:flex-row gap-4 h-full">
                  ...
                  <div
                    class="md:w-1/3 w-full md:flex-shrink-0 md:min-w-[200px]"
                  >
                    <div
                    ...
                    >
                      <MqOgImage
                        ...
                        :style="
                          transition
                            ? `view-transition-name: article-${article.id}; max-width: 100%;`
                            : 'max-width: 100%;'
                        "
                      />
                    </div>
                  ...
                  <!-- テキストコンテンツ -->
                  <div
                    class="w-full flex flex-col justify-between h-full md:flex-1 md:min-w-0"
                  >
                    <div>
                      <h3
                        class="text-lg font-medium text-fg mb-2 whitespace-nowrap overflow-hidden text-ellipsis"
                        :style="
                          transition
                            ? `view-transition-name: article-title-${article.id};`
                            : ''
                        "
                      >
                        {{ article.title }}
                      ...
                      <p
                        class="text-fg-muted text-sm mb-2 overflow-hidden line-clamp-3"
                      >
                        {{ article.summary }}
                      </p>
