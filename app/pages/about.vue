...
<template>
  ...
  >
    <div class="min-h-screen overflow-hidden">
      <div
        class="bg-primary text-white relative w-full max-w-none overflow-hidden md:overflow-visible dot-overlay"
      >
        <div
        ...
        <div class="absolute bottom-0 z-20 w-full h-2/3 pointer-events-none">
          <NuxtImg
            src="/images/about/mai-bg-text.png"
            format="webp"
            alt="Mai Sudachi"
            fetchpriority="high"
        ...
        <div
          class="w-full px-8 pt-[180px] md:pt-[200px] pb-8 max-w-6xl mx-auto relative z-30"
        >
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="z-30 relative">
              <div class="mb-32">
                <p
                  class="mobile-text-outline text-sm md:text-base font-light mb-2"
                >
                  応用睡眠技術者
                </p>
                <div class="w-16 h-0.5 bg-white mb-4"></div>
                <h1
                  class="mobile-text-outline text-5xl md:text-6xl font-bold mb-2"
                >
                  月出里 まい
                </h1>
                ...
                <div class="grid grid-cols-1 space-y-2 mb-8 relative z-30">
                  <NuxtLink
                    v-for="social in socials.filter((s) => s.isFixed)"
                    :key="social.name"
                    :to="social.url"
                    target="_blank"
                    rel="me"
        ...
        <div class="absolute w-full h-full left-0 pointer-events-none">
          <!-- 背景画像 -->
          <div
            class="absolute top-0 z-20 w-full h-full opacity-30 -translate-y-full contrast-120 overflow-hidden"
          >
            <NuxtImg
              src="/images/about/mai-bg.png"
              format="webp"
              alt="doted mai"
              fetchpriority="high"
          ...
          >
            ...
            ></div>
            <NuxtImg
              src="/images/about/mai.png"
              format="webp"
              alt="Mai Sudachi"
              fetchpriority="high"
              class="object-contain max-h-[800px] relative z-[60] ml-auto character-shadow"
              loading="eager"
              decoding="async"
            />
          </div>
      ...
      <!-- ループテキスト -->
      <div
        class="w-full bg-surface-elevated border-t-2 border-b-2 border-accent overflow-hidden py-1"
      >
        <div class="flex whitespace-nowrap">
          <div
            v-for="i in 30"
            :key="i"
            class="animate-marquee flex gap-12 items-center pr-12 select-none shrink-0"
          >
            <span class="text-xs font-semibold tracking-tighter text-accent"
              >SUDACHI MAI</span
            >
              ...
              <div class="md:bg-transparent rounded-lg relative z-20">
                <div class="flex flex-col gap-6 my-4 md:my-8">
                  <div class="flex items-center gap-8">
                    <div>
                      <p
                        class="text-xs tracking-widest font-light text-fg-muted"
                      >
                        ROLE
                      </p>
                    ...
                    <div>
                      ...
                      <NuxtLink
                        to="https://x.com/CSea2073"
                        target="_blank"
                        class="text-xl hover:text-primary transition-all"
                        >しなもん</NuxtLink
                      >
                    </div>
                  </div>
        ...
        <div class="relative z-10 -mt-[100px]">
          ...
          <div class="max-w-[1200px] mx-auto px-4 py-12 md:py-20">
            <div class="w-full">
              ...
              <div class="mb-12">
                <p
                  class="text-sm text-fg-muted tracking-widest mb-3 font-light"
                >
                  SNAPSHOTS
                </p>
                <div class="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                  ...
                  >
                    ...
                    >
                      <div
                        class="w-10 h-10 rounded-full bg-surface-elevated/80 flex items-center justify-center"
                      >
                        <Icon
                          name="ph:play-fill"
                          class="w-4 h-4 text-primary/80 ml-0.5"
                        />
                      </div>
                      <span
                        class="text-xs font-semibold tracking-tighter text-primary"
                        >COMING SOON...</span
                      >
                    </div>
                  </div>
              ...
              <div class="profile mt-12 w-full">
                ...
                <div class="flex flex-wrap justify-between mt-3">
                  ...
                  >
                    <dt
                      class="w-[36%] md:w-[110px] text-fg-muted text-base font-light tracking-wide"
                    >
                      {{ item.label }}
                    </dt>
...
.dot-overlay::after {
  ...
  width: 100%;
  height: 100%;
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAEElEQVR4nGP4//9/GgNlAADe/gNkBNkWTgAAAABJRU5ErkJggg==)
    repeat;
...
.character-shadow {
  filter: drop-shadow(5px -3px 0 #ff8fb0) drop-shadow(10px -5px 0 #ffcada)
